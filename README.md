...
>> Предусмотрены три варианта: **Старт**, **Оптима** и **Премиум**, различающиеся по объему и детализации работ. Отношение к работе от этого не меняется, - меняется только объем/ время услуги, наличие поддержки. 
...
<table style="width:100%; border-collapse: collapse; margin-top: 20px;">
  ...
  <tbody>
    ...
    <tr>
        ...
        <tr>
          <th colspan="4" style="text-align: center; padding-top: 10px;">
            <h4><i>Правки вносятся на финальной стадии каждого блока услуг, - Прайс отдельно от Telegram и Лиги, и наоборот.</i></h4>
          </th>
        </tr>
        <tr>
...
> (!) Поддержка в разделе "прайс" на пол года предусматривают только замену числовых значений.
>> При полной переработке / замене товарных позиций, услуга оплачивается дополнительно, как пакет правок.
